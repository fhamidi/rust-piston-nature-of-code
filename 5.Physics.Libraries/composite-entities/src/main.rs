...
impl Entity {
    fn new(world: &mut World, x: f32, y: f32, color: Color) -> Self {
        ...
        world.create_joint(&b2::DistanceJointDef {
            ...
            ..b2::DistanceJointDef::new(brick.body_handle(), tokens[0].body_handle())
        });
        world.create_joint(&b2::DistanceJointDef {
            collide_connected: true,
            damping_ratio: 0.24,
            ...
            ..b2::DistanceJointDef::new(brick.body_handle(), tokens[1].body_handle())
        });
        Entity {
            brick: brick,
            tokens: tokens,
    ...
    fn render_joints(
        ...
        let token_bodies = [
            world.body(self.tokens[0].body_handle()),
